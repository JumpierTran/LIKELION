...
public class MainAssignment {
	...
	//Tạo thêm các phương thức và định nghĩa lại từ lớp QuanLyKhachSan
...
//		q.themKH(name, tuoi, phong);
		Phong phong1 = q.timPhong(1);
		q.themKH("Hao1", 19, phong1);
		Phong phong2 = q.timPhong(2);
		q.themKH("Hao2", 19, phong2);
		Phong phong3 = q.timPhong(3);
		q.themKH("Hao3", 19, phong3);
		Phong phong4 = q.timPhong(4);
		q.themKH("Hao4", 19, phong4);
		Phong phong5 = q.timPhong(5);
		q.themKH("Hao5", 19, phong5);
	}
...
//		q.themPhong(tenPhong, soPhong);
		q.themPhong("Phong 1", 1);
		q.themPhong("Phong 2", 2);
		q.themPhong("Phong 3", 3);
		q.themPhong("Phong 4", 4);
		q.themPhong("Phong 5", 5);
	}
